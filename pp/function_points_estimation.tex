...
\begin{table}[H]
    ...
    \begin{tabular}{ l | l | l | l }
        ...
        \multirow{6}{*}{\textbf{ILFs}} & ILF1 & High & 15 \\ \cline{2-4}
        							   ...
        							   & ILF4 & Average & 10 \\ \cline{2-4}
        							   & ILF5 & Average & 10 \\ \cline{2-4}
        							   & ILF6 & Low & 7 \\
        \hline
        \textbf{ILF Subtotal} & \multicolumn{2}{c |}{} & \textbf{56} \\
        \hline
        ...
        \multirow{7}{*}{\textbf{EIs}} & EI1 & Low & 3 \\ \cline{2-4}
        							  ...
        							  & EI5 & Average & 4 \\ \cline{2-4}
        							  & EI6 & Average & 4 \\ \cline{2-4}
        							  & EI7 & Low & 3 \\
        \hline
        \textbf{EI Subtotal} & \multicolumn{2}{c |}{} & \textbf{26} \\
        \hline
        \multirow{4}{*}{\textbf{EOs}} & EO1 & Low & 4 \\ \cline{2-4}
        							  & EO2 & Average & 5 \\ \cline{2-4}
        							  & EO3 & Average & 5 \\ \cline{2-4}
        							  & EO4 & Low & 4 \\
        \hline
        \textbf{EO Subtotal} & \multicolumn{2}{c |}{} & \textbf{18} \\
        \hline
         \multirow{2}{*}{\textbf{EQs}} & EQ1 & Low & 3 \\ \cline{2-4}
        							   & EQ2 & Low & 3 \\
        \hline
        \textbf{EQ Subtotal} & \multicolumn{2}{c |}{} & \textbf{6} \\
        \hline
        \hline
        \textbf{Total UFPs} & \multicolumn{2}{c |}{} & \textbf{123} \\
        \hline
    \end{tabular}
