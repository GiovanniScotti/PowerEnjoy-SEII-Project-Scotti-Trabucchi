...
\begin{table}[H]
    ...
    \begin{tabular}{ p{0.2\textwidth} | p{0.45\textwidth} | p{0.45\textwidth} }
        ...
        \hline
        \hline
         \multirow{7}{*}{\textbf{Month 3-4-5}} & External components study & Application logic structuring \\ \cline{2-3}
        & Application logic structuring & User management logic development \\ \cline{2-3}
        & Car reservation logic development & Car reservation logic development \\ \cline{2-3}
        & Interface logic for external systems & Alternative charges situations computation algorithms \\ \cline{2-3}
        ...
        \hline
        \hline
        \multirow{3}{*}{\textbf{Month 6-7}} & Web server tuning & Web server presentation logic \\ \cline{2-3}
        & Website development & External maps service study \\ \cline{2-3}
        & Unit tests for web server logic & Website development \\ \cline{2-3}
        & Code inspection and documentation & Code inspection and documentation \\
        \hline
        \hline
        \multirow{3}{*}{\textbf{Month 8-9}} & On-board devices study & Mobile application structuring \\ \cline{2-3}
