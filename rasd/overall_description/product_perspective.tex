...
An on-board computer is set up in each electric car and it talks to the vehicle control unit through the CAN bus and to the system server via the mobile broadband. Also, the cars are equipped with a thermographic camera, used to detect the number of passengers, drivers included.
...
%insert sum-up architecture picture (draw.io) [see picture by Gio]