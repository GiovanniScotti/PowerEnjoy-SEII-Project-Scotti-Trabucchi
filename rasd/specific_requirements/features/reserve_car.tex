...
\begin{enumerate}
\item The system must not accept as a valid address one outside the Safe Area, either if it is explicitly requested by the user or if it is detected by the GPS position;
