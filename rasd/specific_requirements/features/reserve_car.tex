...
\item The system must consider as valid positions all GPS positions within the Safe Area;
\item The system must consider as valid positions all addresses within the Safe Area;
...
\item The system must only show "available" cars within the Safe Area;
...
\item The system must allow to reserve cars only users that do not have any active reservation;
