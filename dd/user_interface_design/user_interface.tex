...
The following mock-ups show how the interface of the Mobile Application should look like on the user's smartphone.
...
The following mock-ups show how the interface of the On-Board Application should look like on the on-board computers of cars.
