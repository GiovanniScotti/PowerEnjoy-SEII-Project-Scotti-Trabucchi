...
\begin{center}
		...
		\caption{Sequence diagram of the end ride process in case the user parks the car within the Safe Area, highlighting the possibility to contact the Maintenance System in case of emergency after the end of the ride.}
		\label{end_ride_sd}
\end{center}
\end{figure}
