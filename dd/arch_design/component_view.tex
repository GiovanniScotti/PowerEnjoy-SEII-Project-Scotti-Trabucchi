...
\item JDBC as the interface unit with the persistence unit of the Application Server.
\end{itemize}
...
%application server picture [vd denicolao p.14 semplificato]
...
%mobile app picture [vd denicolao p.16]
