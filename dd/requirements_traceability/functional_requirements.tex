Table \ref{functional_traceablity} is aimed to map the functional requirements contained in the related sections of the RASD~\cite{rasd} to the components described in the Design Document.
